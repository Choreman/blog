...
`a_id`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
...
`visits_number`  bigint(20) NULL DEFAULT NULL ,
PRIMARY KEY (`a_id`)
)
ENGINE=InnoDB
...
FOREIGN KEY (`admin_id`) REFERENCES `blog_admin` (`a_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
FOREIGN KEY (`comment_id`) REFERENCES `user_comment` (`ucomment_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- ----------------------------
BEGIN;
INSERT INTO `blog_user` VALUES ('12', '734399815', 'simpkle', '123456', '男', '2016-08-02 00:00:00', '13288508983', '2016-08-26 16:59:57', '201608242334005260kriiokf'), ('13', '123456', 'Doing', '111111', '女', '2016-08-24 00:00:00', '', '2016-09-01 09:27:22', 'default_headPortrait'), ('15', '111111', '111111', '123456', '男', null, '13288508983', '2016-08-31 13:34:59', 'default_headPortrait');
COMMIT;
...
FOREIGN KEY (`user_id`) REFERENCES `blog_user` (`u_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
FOREIGN KEY (`article_id`) REFERENCES `blog_article` (`article_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
INDEX `user_comment_ibfk_1` (`user_id`) USING BTREE ,
INDEX `user_comment_ibfk_2` (`article_id`) USING BTREE 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
AUTO_INCREMENT=43
...
-- ----------------------------
BEGIN;
INSERT INTO `user_comment` VALUES ('3', '评论内容', '2016-08-28 23:45:23', '12', '3'), ('4', '第二条', '2016-08-29 15:22:28', '12', '3'), ('5', '第三条', '2016-08-29 15:22:46', '12', '3'), ('7', '第五条', '2016-08-29 17:00:18', '12', '3'), ('8', '第六条', '2016-08-29 17:00:40', '12', '3'), ('9', '第七条', '2016-08-29 17:01:00', '12', '3'), ('10', '第八条', '2016-08-29 17:07:27', '12', '3'), ('11', '第九条', '2016-08-29 21:14:40', '12', '3'), ('12', '第十条', '2016-08-29 21:14:52', '12', '3'), ('13', '第十一条', '2016-08-29 21:15:05', '12', '3'), ('14', '第十二条', '2016-08-29 21:15:18', '12', '3'), ('15', '第十三条', '2016-08-29 21:15:31', '12', '3'), ('16', '第十四条', '2016-08-30 14:54:46', '12', '3'), ('17', '第十五条', '2016-08-30 15:01:40', '12', '3'), ('18', '第十五条', '2016-08-30 15:01:44', '12', '3'), ('19', '第十五条', '2016-08-30 15:01:44', '12', '3'), ('20', '第十五条', '2016-08-30 15:01:44', '12', '3'), ('21', '第十六条', '2016-08-30 15:02:54', '12', '3'), ('22', '第十七条', '2016-08-30 15:03:31', '12', '3'), ('23', '第十八条', '2016-08-30 15:10:58', '12', '3'), ('24', '第十八条', '2016-08-30 15:11:00', '12', '3'), ('25', '第十九条', '2016-08-30 15:15:09', '12', '3'), ('26', '第二十条', '2016-08-30 15:25:25', '12', '3'), ('27', '第二十一条', '2016-08-30 15:25:44', '12', '3'), ('28', '没用', '2016-08-30 15:26:03', '12', '4'), ('29', '第二条', '2016-08-30 15:26:24', '12', '4'), ('30', '第三条', '2016-08-30 15:26:32', '12', '4'), ('31', '第四条', '2016-08-30 15:26:35', '12', '4'), ('32', '第五条', '2016-08-30 15:26:39', '12', '4'), ('33', '第六条', '2016-08-30 15:26:45', '12', '4'), ('34', '第七条', '2016-08-30 15:26:52', '12', '4'), ('35', '第八条', '2016-08-30 15:26:56', '12', '4'), ('36', '第九条', '2016-08-30 15:27:39', '13', '4'), ('37', '第十条', '2016-08-30 15:27:52', '13', '4'), ('38', '第十一条', '2016-08-30 15:27:57', '13', '4'), ('39', '第十二条', '2016-08-30 15:30:29', '13', '4'), ('40', '第十三条', '2016-08-30 21:13:07', '12', '4');
COMMIT;

-- ----------------------------
-- Auto increment value for `blog_article`
-- ----------------------------
ALTER TABLE `blog_article` AUTO_INCREMENT=16;

-- ----------------------------
-- Auto increment value for `blog_user`
-- ----------------------------
ALTER TABLE `blog_user` AUTO_INCREMENT=16;

-- ----------------------------
-- Auto increment value for `user_comment`
-- ----------------------------
ALTER TABLE `user_comment` AUTO_INCREMENT=43;
